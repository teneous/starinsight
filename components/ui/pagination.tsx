...
export function Pagination({
    ...
    if (startPage > 1) {
      pages.push(
        <Button
          ...
          className={cn('h-8 w-8', currentPage === 1 && 'bg-accent text-accent-foreground')}
        >
          1
        </Button>
      );
    ...
    for (let i = startPage; i <= endPage; i++) {
      pages.push(
        <Button
          ...
          className={cn('h-8 w-8', currentPage === i && 'bg-accent text-accent-foreground')}
        >
          {i}
        </Button>
      );
  ...
  return (
    <div
      className={cn(
        'fixed bottom-0 left-0 right-0 bg-background/80 backdrop-blur border-t border-border',
        className
      )}
    >
